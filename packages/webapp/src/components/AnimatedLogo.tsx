  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* d — original path direction, CSS uses negative dashoffset for correct draw direction */}
        <g className="isolate">
          {COLORS.map((color) => (
            <path
              key={color}
