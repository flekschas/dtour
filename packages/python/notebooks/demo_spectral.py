...
def _(mo):
    ...
    Same data, but now eigenvectors are ordered by discriminative power: the first eigenvector maximally separates cell phenotypes, and each subsequent one adds the next most class-separating direction.
    """)
    return
